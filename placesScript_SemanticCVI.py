# -*- coding: utf-8 -*-
"""
Created on Mon May 15 12:20:10 2023
...
for n in range(0,80):
    os.chdir(r'E:\2D_Semantic_CVI\images')
    img_name = os.listdir(r'E:\2D_Semantic_CVI\images')[n]
...
wb.save('semanticCVISceneDescriptions.xls') 
